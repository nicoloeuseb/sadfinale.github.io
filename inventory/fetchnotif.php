...
//$query = "SELECT * FROM inventory ORDER BY prodid DESC LIMIT 5";
  ...
  while($row = mysqli_fetch_array($result))
  {
   ...
   <li>
    <a href="#">
     ...
     <small><em>'.$row["prodq"]. ' remaining stock</em></small>
    </a>
   </li>
   <li class="divider"></li>
   ';
...
//$query_1 = "SELECT * FROM `inventory` WHERE prodq<5 and comment_status=0 "
