...
if(empty($_SESSION["username"])){
	?> 
	<?php
header("url=http://localhost/sadfinal/sadloginemployee.html");}
	?>
	<?php
...
<div class="w3-sidebar w3-black w3-bar-block w3-card w3-animate-left tag1" style="display:none" id="mySidebar">
  ...
  <a href= "http://localhost/sadfinal/employee/ordered3.php" class="w3-bar-item w3-button" id="button">Orders</a>
...
<div class="w3-container" id="brd"> 
 ...
 <?php while($row = mysqli_fetch_array($search_result)):
                echo "<form action='update_delete_employee.php' method=POST>"; ?>
				<tr>
					...
					<?php echo "<td><button type=submit name=update value=update id=update>update</button></td>"; ?>
...
<div class="bg-modal">
		...
		<div class="close">+</div>
		<form id="registration" method="POST" action="inventory.php" id="insert_form" onsubmit="return Validate()" name="vform">
