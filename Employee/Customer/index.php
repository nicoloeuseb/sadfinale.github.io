...
header("refresh:0;url=SadLoginAdmin.html");}
 ...
 <html>  
      <head>  
	  <style>
	  .body{background-color: rgb(50, 20, 50) ;}
	  #employee th {
    padding-top: 12px;
    padding-bottom: 20px;
    text-align: center;
...
.clr{ background-color:rgb(60, 60, 60);
color: white;
padding-top: 1px;
padding-bottom: 1px;
}
...
#ft{font-family:"didot"; font-size: 18px; }
  ...
  <li class="nav-item">
    <a class="nav-link active is" href="http://localhost/notification/inventoryadmin.php">Inventory</a>
  </li>
  <li class="nav-item">
    <a class="nav-link sup" href="http://localhost/sad/supply/index.php">Supplier</a>
  </li>
   <li class="nav-item">
    <a class="nav-link sup" href="http://localhost/sad/employee/index.php">Employee</a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link disabled logout" href="http://localhost/sad/SadLoginAdmin.html">Logout</a>
  </li>
</ul>
           <br /><br />  
           <div class="container" style="width:700px;">  
                <h3 align="center">Customer Account Details</h3>  
                <br />  
                     ...
                     <div id="employee_table">  
                          <table class="table table-bordered" id="employee">  
                               ...
                               <tr>  <input name="id" value="<?php $row['id'];?>" hidden>
									...
									<?php echo "<td><button type=submit name=delete class=btn btn-info btn-xs view_data del value=delete id=delete>delete</button></td>"; ?>
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                ...
                <div class="modal-footer">  
					 ...
					 <?php echo "<td><button type=submit name=delete value=delete id=delete>delete</button></td>"; ?>
					 <input type="hidden" name="id" value=<?php echo $row['id']?>>		
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                          ...
                          <input type="number" name="contactNum" id="contactNum" class="form-control" />  
                          <br />  
